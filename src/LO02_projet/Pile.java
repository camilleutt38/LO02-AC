...
public class Pile {
	...
	public Pile(){
		...
		Croyant croyant6 = new Croyant("Empeche une divinite poss√©dant le Dogme Nature ou Mystique de sacrifier une de ses cartes de croyants durant ce tour", "Travaileurs", Origine.jour, EtatCarte.pioche, Dogmes.humain, Dogmes.symbole, Dogmes.chaos, 2 );
		System.out.println(croyant6);
		tasDeCroyants.add(croyant6);
		
		Croyant croyant7 = new Croyant("Empeche une divinite poss√©dant le Dogme Nature ou Mystique de sacrifier une de ses cartes de croyants durant ce tour", "Travaileurs", Origine.jour, EtatCarte.pioche, Dogmes.humain, Dogmes.symbole, Dogmes.nature, 2 );
		System.out.println(croyant7);
		tasDeCroyants.add(croyant7);
		
		Croyant croyant8 = new Croyant("Vous piochez deux cartes au hasard dans la main d'une autre Divinit√©", "Travaileurs", Origine.jour, EtatCarte.pioche, Dogmes.humain, Dogmes.mystique, Dogmes.chaos, 2 );
		System.out.println(croyant8);
		tasDeCroyants.add(croyant8);
		
		//creation des Ermites croyants 
		
		Croyant croyant9 = new Croyant("Impose le sacrifice d'un Croyant d'un autre joueur, qui choisit la carte. La capacit√© sp√©ciale du sacrifice est jou√©e.", "Ermite", Origine.jour, EtatCarte.pioche, Dogmes.mystique, Dogmes.nature, Dogmes.chaos, 1);
		System.out.println(croyant9);
		tasDeCroyants.add(croyant9);
		
		Croyant croyant10 = new Croyant("Impose le sacrifice d'un Croyant d'un autre joueur, qui choisit la carte. La capacit√© sp√©ciale du sacrifice est jou√©e.", "Ermite", Origine.jour, EtatCarte.pioche, Dogmes.mystique, Dogmes.nature, Dogmes.symbole, 1);
		System.out.println(croyant10);
		tasDeCroyants.add(croyant10);
		
		//Creation de l'Int√©griste Croyant
		
		Croyant croyant11 = new Croyant("Impose le sacrifice d'un Guide Spirituel d'un autre joueur, qui choisit la carte. La capacit√© sp√©ciale du sacrifice est jou√©e.", "Int√©gristes", Origine.jour, EtatCarte.pioche, Dogmes.humain, Dogmes.nature, Dogmes.chaos, 1);
		System.out.println(croyant11);
		tasDeCroyants.add(croyant11);
		
		//Creation du Guerrier Saint croyant
		
		Croyant croyant12 = new Croyant("Un Guide Spirituel revient dans la main de sa Divinit√©. Ses Croyants reviennent au centre de la table.", "Guerriers Saints", Origine.jour, EtatCarte.pioche, Dogmes.mystique, Dogmes.nature, Dogmes.symbole, 4);
		System.out.println(croyant12);
		tasDeCroyants.add(croyant12);
		
		// Creation du Diplomates Croyant
		
		Croyant croyant13 = new Croyant("Relancez le d√© de Cosmogonie. Le tour se finit normalement sous la nouvelle influence", "Diplomates", Origine.jour, EtatCarte.pioche, Dogmes.humain, Dogmes.symbole, Dogmes.chaos, 4);
		...
		Croyant croyant19 = new Croyant("Empeche une DivinitÈ possÈdant le Dogme Humain ou Mystique de sacrifier une de ses cartes de Croyants durant ce tour de jeu.", "Alchimistes", Origine.nuit, EtatCarte.pioche, Dogmes.chaos, Dogmes.nature, Dogmes.symbole, 2);
		System.out.println(croyant19);
		tasDeCroyants.add(croyant19);
		
		Croyant croyant20 = new Croyant("EmpÍche une DivinitÈ possÈdant le Dogme Humain ou Symboles de sacrifier un de ses Guides Spirituels durant ce tour de jeu. ", "Alchimistes", Origine.nuit, EtatCarte.pioche, Dogmes.chaos, Dogmes.nature, Dogmes.mystique, 2);
		...
		Croyant croyant22 = new Croyant("Impose le sacrifice d'un Croyant d'un autre joueur. Celui-ci choisit le sacrifiÈ. La capacitÈ spÈciale du sacrifice est jouÈe", "Vampires", Origine.nuit, EtatCarte.pioche, Dogmes.humain, Dogmes.nature, Dogmes.symbole, 1);
		System.out.println(croyant22);
		tasDeCroyants.add(croyant22);
		
		Croyant croyant23 = new Croyant("Impose le sacrifice d'un Croyant d'un autre joueur. Celui-ci choisit le sacrifiÈ. La capacitÈ spÈciale du sacrifice est jouÈe", "Vampires", Origine.nuit, EtatCarte.pioche, Dogmes.humain, Dogmes.chaos, Dogmes.mystique, 1);
		...
		Croyant croyant35 = new Croyant("Lancez le dÈ de Cosmgonie. Le tour se fini normalement, mais sous cette nouvelle influence.", "Revenant", Origine.neant, EtatCarte.pioche, Dogmes.mystique, Dogmes.humain, Dogmes.nature, 1);
